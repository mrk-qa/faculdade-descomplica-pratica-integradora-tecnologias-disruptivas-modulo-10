...
const initialRows = [
  createData(1, 'Desenvolver header da página 2', 'Desenvolvimento do header da página 2', '2022-01-01', '2022-01-02', 'Concluída', 'Recurso 1'),
  createData(2, 'Desenvolver anúncio', 'Desenvolvimento do anúncio', '2022-01-03', '2022-01-04', 'Em Andamento', 'Recurso 2'),
  createData(3, 'Inserir no backlog a criação de uma nova API compras', 'Criação da API do endpoint /v2/compras', '2022-01-04', '2022-01-05', 'Em Andamento', 'Recurso 3')
];
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      ...
                      <TableCell align="center">
                        <Button variant="contained" onClick={() => handleEditar(row.idTarefa)}><EditIcon fontSize="small" /></Button>            
                      </TableCell>
                      <TableCell align="center">
